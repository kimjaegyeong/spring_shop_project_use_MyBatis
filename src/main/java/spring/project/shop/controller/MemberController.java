...
import spring.project.shop.service.memberservice.MemoryMemberService;
...
public class MemberController {
    ...
    public String signUp(Member member, RedirectAttributes redirectAttributes){
        ...
        String memberId=memberService.general_signUp(member);
    ...
    public String login(@RequestParam String memberId, @RequestParam String password,
           ...
           String id= memberService.login(memberId, password);
           //세션부여
    ...
    public String mypageUpdate(Member member){
            String update_memberId = memberService.userUpdate(member);
    ...
    public void init(){
        ...
        memberService.general_signUp(member); }
}

...
public class MybatisMemberController {
    ...
    @GetMapping("/mypage/remove/{memberId}")
    public String remove(Member member){
        mybatisMemberService.userRemove(member);
        return "redirect:/shop/login";
    }
    ...
    public String findAll(Model model) {
        List<Member> members = mybatisMemberService.findAll();
    ...
    public String myOrderPage(@PathVariable String deliveryCode, Model model) {
        Delivery delivery = mybatisDeliveryService.showDelivery(deliveryCode);
